...
interface EmailTemplate {
  id: number;
  name: string;
  type: 'welcome' | 'newsletter' | 'promotion' | 'notification' | 'reminder' | 'birthday' | 'custom' | 'reward_confirmation';
  subject: string;
...
const EmailSection: React.FC = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'reward_confirmation': return 'bg-emerald-100 text-emerald-800';
      default: return 'bg-gray-100 text-gray-800';
    }
  };
  ...
  const getTypeLabel = (type: string) => {
    switch (type) {
      ...
      case 'reward_confirmation': return 'Confirmación de Canje';
      default: return type;
    }
  };
