...
const EditUserModal: React.FC<EditUserModalProps> = ({
  ...
  const [formData, setFormData] = useState<User>({
    ...
    cajero_version: "web" as "web" | "tpv" | undefined,
  });
  ...
  useEffect(() => {
    if (user) {
      ...
      setFormData({
        ...
        ...((user as any).cajero_version && { cajero_version: (user as any).cajero_version }),
      });
    }
  }, [user]);
  ...
  const handleCajeroVersionChange = (version: 'web' | 'tpv') => {
    setFormData((prev) => ({
      ...prev,
      cajero_version: version,
    }));
  };
        ...
        <AnimatePresence mode="wait">
          {activeTab === "basic" && (
            <BasicInfoForm
              ...
              onCajeroVersionChange={handleCajeroVersionChange}
            />
          )}
