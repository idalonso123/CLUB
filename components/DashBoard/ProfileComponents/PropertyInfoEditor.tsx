...
const PropertyInfoEditor: React.FC<PropertyInfoEditorProps> = ({
  ...
  return (
    ...
    >
      <h3 className="text-xl font-semibold mb-4 text-green-700">Información de Propiedad</h3>
        ...
        <div className="space-y-3">
          ...
          {(safeUserData.property.characteristics?.length > 0) && (
            <div className="p-3 bg-gray-50 rounded">
              <div className="font-medium mb-1">Características de la vivienda:</div>
          ...
          {(safeUserData.property.animals?.length > 0) && (
            <div className="p-3 bg-gray-50 rounded">
              <div className="font-medium mb-1">Animales:</div>
              <div className="flex flex-wrap gap-1">
