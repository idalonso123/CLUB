...
import ContactInfoEditor from '@/components/DashBoard/ProfileComponents/ContactInfoEditor';
    ...
    return (
        ...
        >
            ...
            <ContactInfoEditor
                ...
                handleChange={handleChange}
                startEditing={() => startEditing('contact')}
                saveSection={() => saveSection('contact')}
                cancelEdit={() => cancelEdit('contact')}
                itemVariants={itemVariants}
