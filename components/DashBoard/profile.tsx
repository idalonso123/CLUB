...
const UserProfile = () => {
    ...
    // Función para cerrar sesión desde Mi perfil
    ...
    return (
        ...
        >
            ...
            {/* Botón de Cerrar Sesión - Con el mismo color verde que "Iniciar sesión" */}
            <motion.div
                variants={itemVariants}
            ...
            >
                <button
                    ...
                    className="w-full py-3 px-4 bg-green-800 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
                >
