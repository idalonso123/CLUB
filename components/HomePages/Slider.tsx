...
const Slider = ({
  ...
  return (
    <div className="w-full overflow-hidden rounded-xl shadow-lg relative h-[492px] sm:h-[392px] md:h-[376px]">
      <AnimatePresence initial={false} custom={direction} mode="wait">
        ...
        >
          <div className="min-w-full bg-white flex flex-col md:flex-row overflow-hidden h-full w-full">
            ...
            {/* Contenido del slider - reducido el espacio en móvil a 8px */}
            <div className="w-full md:w-2/5 p-2 sm:p-5 md:p-6 flex flex-col justify-center bg-gradient-to-r from-white to-green-50 h-1/2 sm:h-2/5 md:h-full">
              <motion.h2
