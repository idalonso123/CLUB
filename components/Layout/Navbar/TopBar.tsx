 ...
 *
 * Esta barra está BLOQUEADA mediante CSS con !important en globals.css
 * para garantizar que siempre sea visible y esté en la parte superior.
 *
 * Características bloqueadas:
 * - position: fixed
 * - top: 0
 * - z-index: 99999 (el más alto)
 * - width: 100%
 */
