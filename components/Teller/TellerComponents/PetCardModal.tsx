                          ...
                          <div className={`p-3 ${card.completed ? 'bg-green-50' : 'bg-white'}`}>
                            <div className="flex justify-between items-start mb-3">
                              ...
                              <div className="flex items-center gap-2">
                                <div className={`px-2 py-1 rounded text-xs font-medium ${card.completed ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'}`}>
                                  {card.completed ? 'Completado' : 'Activo'}
                                </div>
                                <button
