  ...
  if (req.method === 'GET') {
    try {
      ...
      const formattedUsers = (usersResult as any[]).map(user => ({
        ...
        // El usuario está suscrito si no está definido emailSubscribed o si es true
        // El campo emailSubscribed se obtendrá de la tabla email_subscribers en el frontend
      }));
