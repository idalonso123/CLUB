...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const resetUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://clubviveverde.com'}/cambiar-password?token=${resetToken}`;
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <img src="${process.env.NEXT_PUBLIC_SITE_URL || 'https://clubviveverde.com'}/icons/Logo-ViveVerde.png" alt="ViveVerde" style="height: 60px;" />
          </div>
